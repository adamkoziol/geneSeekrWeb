...
sub generateHeader {
	# Start HTML
	print $cgi->start_html(-title=>'CFIA ACIA GeneSippr',
			 -style=> {
...
sub display {
	...
	print $cgi->p("Welcome to the CFIA GeneSippr.<br> The GeneSippr uses raw sequence data as input to determine the presence of certain markers 
	...
	print $cgi->start_form(-method => 'POST',
                         -id => 'upload_form',
                         -name => 'upload_form',
                         -action => "/cgi-bin/geneSeekr/geneSippr_results.cgi",
